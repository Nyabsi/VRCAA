...
class IconGalleryScreen : Screen {
    ...
    override fun Content() {
        ...
        when (val result = state) {
            is IconGalleryScreenModel.GalleryState.Loading -> LoadingIndicatorScreen().Content()
            is IconGalleryScreenModel.GalleryState.Empty -> HandleEmpty()
            is IconGalleryScreenModel.GalleryState.Result -> DisplayResult(result.files, model)
            else -> {}
        }
    }
