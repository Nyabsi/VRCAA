...
class FriendsScreen : Screen {
    ...
    fun ShowFriendsFavorite(
        ...
        val favoriteFriends = friends.value.filter { FavoriteManager.isFavorite("friend", it.id) && it.location.contains("wrld_").not() && it.state == "active" && it.platform != "web" }
        val favoriteFriendsInInstances = friends.value.filter { FavoriteManager.isFavorite("friend", it.id) && it.location.contains("wrld_") && it.platform != "web" &&  it.state == "active" }
        val favoriteFriendsOffline = friends.value.filter { FavoriteManager.isFavorite("friend", it.id) && it.platform.isEmpty() && it.state == "offline" }
    ...
    fun ShowFriendsOnWebsite(
        ...
        val filteredFriends = friends.value.filter { it.platform == "web" && it.state == "active" }
    ...
    fun ShowFriends(
        ...
        val filteredFriends = friends.value.filter { !FavoriteManager.isFavorite("friend", it.id) && it.state != "offline" && it.location.contains("wrld_").not() && it.platform.isNotEmpty() && it.platform != "web" }
        val filteredFriendsInInstances = friends.value.filter { !FavoriteManager.isFavorite("friend", it.id) && it.location.contains("wrld_") && it.platform.isNotEmpty() && it.platform != "web" && it.state == "active" }
    ...
    fun ShowFriendsOffline(
        ...
        val filteredFriends = friends.value.filter { !FavoriteManager.isFavorite("friend", it.id) && it.state == "offline" && it.platform.isEmpty() }
        if (filteredFriends.isEmpty()) {
            Column(
                modifier = Modifier.fillMaxSize(),
                verticalArrangement = Arrangement.Center,
