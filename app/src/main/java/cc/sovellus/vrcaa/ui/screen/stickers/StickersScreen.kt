...
class StickersScreen : Screen {
    ...
    override fun Content() {
        ...
        when (val result = state) {
            is StickersScreenModel.ItemsState.Loading -> LoadingIndicatorScreen().Content()
            is StickersScreenModel.ItemsState.Empty -> HandleEmpty()
            is StickersScreenModel.ItemsState.Result -> DisplayResult(result.stickers, result.userStickers, result.archivedStickers, model)
            else -> {}
        }
    }
