...
interface IFavorites {
    ...
    suspend fun fetchFavoriteAvatarsByUserId(userId: String, tag: String, n: Int = 100, offset: Int = 0, favorites: ArrayList<FavoriteAvatar> = arrayListOf()): ArrayList<FavoriteAvatar>
